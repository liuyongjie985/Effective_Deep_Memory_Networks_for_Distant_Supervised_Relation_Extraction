...
def model_mimlcnn(datasets, Wordv, PF1v, PF2v, img_h, RForAT, WForAT):
    """
    模型建模.
    ...
    normalre, dropoutre = my_mlp_layer.feed(idx, ok,
                                            input_shape=(_N_RELATIONS, _BATCH_SIZE, (_MLP_SHAPE[0])))
...
def run_mimlcnnre(file_name):
    ...
    train_update_model, trainset_error_model, testset_error_model, set_zero, init_LR_W, init_LR_b = \
        model_mimlcnn(datasets_ready, Wordv, PF1v, PF2v, img_h, RForAT, WForAT)
